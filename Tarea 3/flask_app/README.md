...
3. Ahora si se registra un miembro con los mismos datos a uno ya existete, no se agrega una vez más, si no que solo se agrega la actividad con el miembro_id igual a uno ya existente.
